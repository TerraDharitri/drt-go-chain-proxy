...
// ErrNilDCDTSuppliesProcessor signals that a nil dcdt supplies processor has been provided
var ErrNilDCDTSuppliesProcessor = errors.New("nil dcdt supplies processor")
