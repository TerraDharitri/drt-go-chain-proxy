...
// ErrInvalidIterateKeysRequestData signals that an invalid input has been provided
var ErrInvalidIterateKeysRequestData = errors.New("invalid iterate keys request data")
